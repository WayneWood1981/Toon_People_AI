...
[CustomEditor(typeof(MaleVRTPPrefabMaker))]

public class EditorMaleVRAvatarPrefabMakerTP : Editor
{
    public override void OnInspectorGUI()
    {
        MaleVRTPPrefabMaker myPrefabMaker = (MaleVRTPPrefabMaker)target;
        ...
        else
        {
            ...
            GUILayout.BeginHorizontal("box");
            if (GUILayout.Button("BEARD", GUILayout.Width(115), GUILayout.Height(20))) { myPrefabMaker.BeardOn(); }
